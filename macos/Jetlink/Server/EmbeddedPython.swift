...
enum PythonRuntimeError: Error, LocalizedError, Equatable {
  ...
  var errorDescription: String? {
    switch self {
    case .notBundled:
      return "Jetlink cannot find its Python runtime. Run make python in the macos directory, or set JETLINK_PYTHON to an interpreter that has the jetlink package installed."
